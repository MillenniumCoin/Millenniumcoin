...
#uncomment the following section to enable building on win32:
win32:{
LIBS += -lshlwapi
LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,) $$join(LIBEVENT_LIB_PATH,,-L,) 
LIBS += -ldb_cxx$$BDB_LIB_SUFFIX -levent -levent_core
win32:LIBS += -lws2_32 -lssl -lcrypto -lole32 -loleaut32 -luuid -lgdi32 -lcrypt32
...
# use: qmake "RELEASE=1"
contains(RELEASE, 1) {
    # Mac: compile for Maverick only (10.9, 64-bit)
...
isEmpty(BOOST_LIB_SUFFIX) {
    ...
    win32:BOOST_LIB_SUFFIX = -mgw48-mt-s-1_55_0
}
